...
our %config = (
  ...
  CPPFLAGS => [ "-DANDROID -D__ANDROID_API__=21 -I/home/dev/.buildozer/android/platform/android-ndk-r19c/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include/aarch64-linux-android -I/home/dev/Development/cardlessTransaction/cardless-transaction/forBuildozer/.buildozer/android/platform/build-arm64-v8a_armeabi-v7a/build/python-installs/myapp/arm64-v8a/include/python3.8" ],
  CPPINCLUDES => [  ],
  CXX => "/home/dev/.buildozer/android/platform/android-ndk-r19c/toolchains/llvm/prebuilt/linux-x86_64/bin/clang++ -target aarch64-linux-android21 -fomit-frame-pointer -march=armv8-a",
  CXXFLAGS => [ "-target aarch64-linux-android21 -fomit-frame-pointer -march=armv8-a" ],
  HASHBANGPERL => "/usr/bin/env perl",
  LDFLAGS => [ "  -L/home/dev/Development/cardlessTransaction/cardless-transaction/forBuildozer/.buildozer/android/platform/build-arm64-v8a_armeabi-v7a/build/libs_collections/myapp/arm64-v8a" ],
  LDLIBS => [ "-lm" ],
  PERL => "/usr/bin/perl",
  RANLIB => ":",
  RC => "windres",

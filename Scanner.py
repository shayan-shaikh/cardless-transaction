...
class Qrcodedetector(MDApp):
    ...
    def build(self):
        ...
        self.save_img_button = (MDFillRoundFlatButton(text="Detect URL", pos_hint={
                                'center_x': 0.5, 'center_y': 0.3}, size_hint=(None, None)))
    ...
    def take_picture(self, *args):
        ...
        print(qrdata)
        name_str = open("name_str.txt", "w")
        name_str.write(qrdata)
        name_str.close()
        subprocess.call("transaction.py", shell=True)
        return qrdata
